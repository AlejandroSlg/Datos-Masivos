...
/*Creamos la variable "data"  para leer el archivo CSV llamado "Advertising"*/
...
/*Creamos una nueva clolumna llamada "Hour" del Timestamp*/
...
/*Importacion de las librerias VectorAssembler y Vectors*/
import org.apache.spark.ml.feature.VectorAssembler
import org.apache.spark.ml.linalg.Vectors

/*Creacion de un nuevo objecto VectorAssembler llamado assembler para los feature las cuales seran las columnas restantes del dataset*/
...
/*Importamos la libreria de  MulticlassMetrics*/
import org.apache.spark.mllib.evaluation.MulticlassMetrics

/*Convertimos los resutalos de la prueba (test) en RDD */
val predictionAndLabels = results.select($"prediction",$"label").as[(Double, Double)].rdd

/*Inicializamos el objeto MulticlassMetrics con el parametro predictionAndLabels */
val metrics = new MulticlassMetrics(predictionAndLabels)

/* Impresion de la matrix de confusion*/
println("Confusion matrix:")
println(metrics.confusionMatrix)

/* Imprimimos la exactitud de nuestra predicion*/
metrics.accuracy
